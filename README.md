...
## OUTPUT:
## float datatype
![image](https://github.com/Rakshithadevi/PCA-EXP-2-MATRIX-SUMMATION-USING-2D-GRIDS-AND-2D-BLOCKS-AY-23-24/assets/94165326/369e9409-8c70-4473-823c-d3cd6fdc26db)

## integer datatype
![image](https://github.com/Rakshithadevi/PCA-EXP-2-MATRIX-SUMMATION-USING-2D-GRIDS-AND-2D-BLOCKS-AY-23-24/assets/94165326/21b1cfba-fa7d-4fd9-b6d7-bd36354e0f29)


## RESULT:
Float : The host took 0.834905 sec seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.013761 sec. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully. Integer : The host took  0.897025 sec to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.075308 seconds. Therefore, integer variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
